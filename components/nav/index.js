      ...
      <div className={`${s["nav"]}`}>
        <div className={`${s["nav__wrapper"]}`}>
          <div className={`${s["nav__right"]}`}>
            <h4 className={`${s["nav__title"]}`}>DMS</h4>
          ...
          <div className={`${s["nav__left"]}`}>
            <ul className={`${s["nav__links"]}`}>
              ...
              <li className={`${s["nav__link"]} ${ifActive("chat",active)}`}><a href="https://smhacksdonate.github.io/motivate/chat/index" target="_blank">Chat</a></li>
